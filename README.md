# GEOMUSIC
Geomusic is a web-based application to search and localize musical events depending the input information: a band name, name of festivals or places.
It use LASTFM API to search data information and GOOGLE MAPS to display that in a world map.
 ...
 * Angel Bueno (Github user: @srsudo)
...
Otro elemento importante ha sido la forja de la asignatura para poder trabajar todos de manera conjunta, aunque bien es cierto que al final unicamente se utilizaron los archivos subidos como copia de seguridad ya que aprendimos a trabajar de manera independiente con bases de datos en iriscouch. 
